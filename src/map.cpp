...
int Board::get_column_size() const { return columns_; }

int Board::get_row_size() const { return rows_; }
    ...
    for (int x = 0; x < columns_; ++x) {
      switch (map_array[y][x]) {
        case 1:
          ...
          break;
        case 2:
          set_tile_at(x, y, "reef");
          break;
        case 3:
          set_tile_at(x, y, "plains");
          break;
        case 4:
          set_tile_at(x, y, "hill");
          break;
        case 5:
          set_tile_at(x, y, "mountain");
          break;
        case 6:
          set_tile_at(x, y, "shadow_plains");
          break;
      }
    }
  }
